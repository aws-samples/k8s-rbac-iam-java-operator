...
import com.octank.kubernetes.model.IamUserGroupCustomObjectList;
import com.octank.kubernetes.model.IamUserGroupCustomObjectSpec;
...
public class IAMEventHandler implements RequestStreamHandler {
	...
	private static final Logger logger = Logger.getLogger(IAMEventHandler.class);
